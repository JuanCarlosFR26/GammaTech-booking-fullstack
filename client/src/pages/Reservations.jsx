...
import FormWithInputs from "../components/FormWithInputs";
...
const Reservations = () => {
  ...
  useEffect(() => {
    getData(`http://localhost:8001/reservations`).then((res) =>
      setReservationsList(res.result)
    );
  }, []);

  return (
    <div className="bg-white h-screen flex flex-col items-center">
      <h1 className="text-3xl font-bold mt-8">Make your reservation</h1>
      <FormWithInputs />
      <h1 className="text-2xl font-bold mt-8">Reservations:</h1>
      <div className="mt-8">
        {reservationsList ? (

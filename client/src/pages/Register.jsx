    ...
    <>
      <div className="flex justify-center items-center h-screen">
        ...
        <div className="flex items-center justify-center w-2/4 h-screen bg-yellow-100">
          <Form text={"Register"} path={'/login'} handleSubmit={handleSubmit} onChangeEmail={(e) => setEmail(e.target.value)} onChangePassword={(e) => setPassword(e.target.value)} linkText={'Ya tienes una cuenta?'}/>
        </div>
      </div>
    </>
  );
